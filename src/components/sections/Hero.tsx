...
export function Hero() {
  return (
    <section id="about" className="min-h-[85vh] flex flex-col md:flex-row items-center justify-between pt-20 relative gap-12">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter mb-6 leading-[1.1]">
          Hi, I'm <br />
          <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Umer Memon</span>
        </h1>
        ...
        >
          A passionate full-stack engineer crafting beautiful, responsive web experiences from <span className="text-foreground">Karachi</span>.
        </motion.p>
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <a href="https://www.linkedin.com/in/umer-the-dev/" target="_blank" rel="noreferrer">
              <Button size="lg" className="rounded-full px-8 h-14 text-base shadow-[0_0_40px_-10px_rgba(var(--primary),0.5)]">
        ...
        >
          <a href="https://github.com/umermemon1" target="_blank" rel="noreferrer" className="p-4 bg-background/50 border border-border/50 rounded-full hover:bg-primary hover:text-primary-foreground hover:scale-110 transition-all shadow-lg hover:shadow-primary/20">
          ...
          <a href="https://www.linkedin.com/in/umer-the-dev/" target="_blank" rel="noreferrer" className="p-4 bg-background/50 border border-border/50 rounded-full hover:bg-[#0A66C2] hover:text-white hover:scale-110 transition-all shadow-lg hover:shadow-[#0A66C2]/20">
          ...
          <a href="https://wa.me/923161395147" target="_blank" rel="noreferrer" className="p-4 bg-background/50 border border-border/50 rounded-full hover:bg-[#25D366] hover:text-white hover:scale-110 transition-all shadow-lg hover:shadow-[#25D366]/20">
      ...
      >
        ...
        >
          <span className="text-3xl lg:text-4xl font-bold text-primary">2+</span>
          <span className="text-xs lg:text-sm font-medium text-muted-foreground uppercase tracking-wider">Years Exp</span>
        </motion.div>
        ...
        >
          <span className="text-3xl lg:text-4xl font-bold text-accent">42+</span>
          <span className="text-xs lg:text-sm font-medium text-muted-foreground uppercase tracking-wider">Projects</span>
        </motion.div>
      </motion.div>
    </section>
  )
