...
const projects = [
  {
    title: "DilseBuy",
    description: "Modern e-commerce interface with clean design, intuitive navigation, and responsive layout.",
  ...
  {
    title: "Calculator",
    description: "Responsive calculator application with sleek interface for all basic mathematical operations.",
  ...
  {
    title: "Quiz App",
    description: "Interactive quiz application with dynamic questions and real-time score tracking.",
  ...
  {
    title: "Car Website",
    description: "Automotive showcase website featuring detailed specs and elegant modern design.",
  ...
  },
  {
    ...
    description: "Pixel-perfect recreation of Starbucks website using pure HTML and CSS.",
    tags: ["Clone", "CSS"],
  ...
  {
    title: "Chess Board",
    description: "CSS-styled chessboard demonstrating advanced layout and design mastery.",
    tags: ["Game", "CSS Grid"],
    ...
    <section id="work" className="py-20">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-2xl text-xl">
          A showcase of my recent web development projects combining creativity and functionality.
        </p>
      </motion.div>
            ...
            <a href={project.link} target="_blank" rel="noreferrer" className="block h-full">
              <Card className="overflow-hidden bg-background/40 backdrop-blur-md border-border/50 group-hover:border-primary/50 transition-all duration-500 h-full flex flex-col shadow-lg group-hover:shadow-2xl group-hover:shadow-primary/10">
                <div className="h-56 relative overflow-hidden flex items-center justify-center bg-muted/20">
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${project.color} opacity-40 group-hover:opacity-80 transition-all duration-700 -z-10`} />
                ...
                <CardContent className="p-8 flex-1 flex flex-col relative z-20 bg-background/80">
                  ...
                  <p className="text-muted-foreground mb-8 flex-1 text-lg leading-relaxed">{project.description}</p>
                  <div className="flex flex-wrap gap-2 mt-auto">
                    {project.tags.map(tag => (
                      <Badge key={tag} variant="secondary" className="bg-secondary/50 hover:bg-primary hover:text-primary-foreground transition-colors px-3 py-1 text-sm">
                        {tag}
                      </Badge>
                    ))}
                  </div>
